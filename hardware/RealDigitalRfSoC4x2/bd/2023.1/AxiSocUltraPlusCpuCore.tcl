...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {axiLite:dmaCtrl:dma} \
...
\
    ...
    CONFIG.PSU__CRF_APB__DDR_CTRL__ACT_FREQMHZ {500.000000} \
    ...
    CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__ACT_FREQMHZ {20.000000} \
...
\
  ...
  connect_bd_net -net maxihpm1_fpd_aclk_0_1 [get_bd_ports dmaClk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins axi_protocol_convert_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
