...
\
  ...
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM1_FPD [get_bd_intf_pins ps_e/M_AXI_HPM1_FPD] [get_bd_intf_pins axi_protocol_convert_1/S_AXI]
  ...
  set_property PFM_NAME {xilinx.com:xd:zcu111:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {dmaClk {id "4" is_default "true" proc_sys_reset "" status "fixed" freq_hz "250000000"}} [get_bd_ports /dmaClk]
