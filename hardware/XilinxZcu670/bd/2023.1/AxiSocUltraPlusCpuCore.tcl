...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {plRstL} \
   CONFIG.FREQ_HZ {250000000} \
 ] $plClk
  set pmuErrorToPl [ create_bd_port -dir O -from 46 -to 0 pmuErrorToPl ]
...
\
  ...
  connect_bd_intf_net -intf_net S_AXI_HP0_FPD_0_1 [get_bd_intf_ports dma] [get_bd_intf_pins ps_e/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_protocol_convert_1_M_AXI [get_bd_intf_ports dmaCtrl] [get_bd_intf_pins axi_protocol_convert_1/M_AXI]
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM0_FPD [get_bd_intf_pins ps_e/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_protocol_convert_0/S_AXI]
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM1_FPD [get_bd_intf_pins axi_protocol_convert_1/S_AXI] [get_bd_intf_pins ps_e/M_AXI_HPM1_FPD]
  ...
  connect_bd_net -net maxihpm0_fpd_aclk_0_1 [get_bd_ports dmaClk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/maxihpm1_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins axi_protocol_convert_1/aclk]
  ...
  connect_bd_net -net ps_e_pl_resetn0 [get_bd_pins ps_e/pl_resetn0] [get_bd_ports plRstL]
  connect_bd_net -net ps_e_pmu_error_to_pl [get_bd_pins ps_e/pmu_error_to_pl] [get_bd_ports pmuErrorToPl]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_ports fanEnableL]

  # Create address segments
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs axiLite/Reg] -force
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs dmaCtrl/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces dma] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dma] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dma] [get_bd_addr_segs ps_e/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces dma] [get_bd_addr_segs ps_e/SAXIGP2/HP0_QSPI] -force
  ...
  set_property PFM_NAME {xilinx.com:xd:zcu670:1.0} [get_files [current_bd_design].bd]
